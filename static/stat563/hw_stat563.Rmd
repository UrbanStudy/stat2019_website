...
$$\frac{\partial}{\partial\theta}\ln L(\theta,x_{(1)}|x)=\frac{n}\theta+n\ln x_{(1)}-\ln(\prod_i x_i)=0$$
...
We will not use the hint, although the problem can be solved that way. Instead, make the following three transformations. 
