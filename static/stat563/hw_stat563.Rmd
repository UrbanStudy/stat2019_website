...
For $\frac{\partial^2 f(b)}{\partial b^2}=c>0$, $b=\frac{-(S_{xx}-S_{yy})+\sqrt{(S_{xx}-S_{yy})^2 +4S_{xy}^2}}{2S_{xy}}$ has gives the minimum of $f(b)$.
...
$\lambda=V[x]/V[y]=S_{xx}/S_{yy}=0.006696296$
