...
$$=\sum_{i=1}^{n-1}n\rho^{i}-\sum_{i=1}^{n-1}i\rho^{i}=n\frac{1-\rho^{n}}{1-\rho}-\frac{n(-1+\rho)\rho^{n}+\rho(1-\rho^{n})}{(1-\rho)^2}=\frac{n\rho(1-\rho)-\rho(1-\rho^{n})}{(1-\rho)^2}=\frac{\rho}{1-\rho}(n-\frac{1-\rho^n}{1-\rho})$$

$$Var[\bar X]=\frac{\sigma^2}{n}+\frac2{n^2}\frac{\rho}{1-\rho}(n-\frac{1-\rho^n}{1-\rho})$$

 ---
 
 $$EX_{i+1}=E[\rho X_i+\delta_i]=\rho E[X_i]$$
...
$$=Var[\rho^{i−1}EX_1]+E[\rho^2 VarX_1+1]=\rho^2\sigma^2+1=\sigma^2$$

Note: $\sigma^2-\rho^2\sigma^2=1$
