...
$$=\frac{S_{xx}}{2S_{xy}\lambda^2}+\frac1{2S_{xy}\lambda^2}[4S_{xy}^2\lambda +(S_{xx}-S_{yy}\lambda)^2]^{-\frac12}[S_{yy}S_{xx}\lambda-S_{xx}^2-2\lambda S_{xy}^2]$$
...
For $\lambda=1$, $S_{yy}\ge0$, $S_{xx}\ge0$, and the formula in (a), when $S_{xy}>0$,

$$\hat\beta(\lambda)=\frac{-(S_{xx}-S_{yy}) + \sqrt{(S_{xx}-S_{yy})^2 +4S_{xy}^2}}{2S_{xy}}\le\frac{S_{yy} + \sqrt{(-S_{yy})^2 }}{2S_{xy}}=\frac{S_{yy}}{S_{xy}}$$

$$\hat\beta(\lambda)=\frac{2S_{xy}}{(S_{xx}-S_{yy}) + \sqrt{(S_{xx}-S_{yy})^2 +4S_{xy}^2}}\ge\frac{2S_{xy}}{S_{xx} + \sqrt{(S_{xx})^2 }}=\frac{S_{xy}}{S_{xx}}$$

When $S_{xy}<0$, $\frac{-S_{xy}}{S_{xx}}<-\hat\beta(\lambda)<\frac{S_{yy}}{-S_{xy}}$, therefore,
...
$\hat\lambda=\hat\sigma^2_{\delta}/\hat\sigma^2_{\varepsilon}=\frac{S_{xx}/n}{S_{yy}/n}=0.006696296$
