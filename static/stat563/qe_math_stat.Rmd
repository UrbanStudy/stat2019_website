...
power$=P_{\theta_1}(x_1<2/3)=1-\int_0^{2/3}f(x|\theta_1)=20/27$
...
$F_U(u)=\begin{cases}0&u<0\\\int_0^u=\frac{u^2}2&0\le u\le1\\2u-\frac{u^2}2-1&1\le u\le2\\1&u>2\end{cases}$
...
$L(\sigma^2)=(2\pi\sigma^2)^{-\frac{n}2}e^{\frac1{2\sigma^2}\sum(x-120)^2}$

$\Lambda=(\frac{\sigma_1^2}4)^{\frac{n}2}e^{(\frac1{2\sigma^2}-\frac18)\sum(x-120)^2}\le c$

$T=\sum(x-120)^2$ suffi, $\sigma^2<4$ MLR $\Lambda\nearrow T\le c$, $\sigma^2>4$ MLR $\Lambda\searrow T\ge c$ 
...
**Example 4.3.3 (Distribution of the product of beta variables)** Let $X\sim Beta(\alpha,\beta)$ and $Y\sim Beta(\alpha+\beta,\gamma)$ be independent random variables. The joint pdf of $(X,Y)

$U=XY$, $f_U(u)\sim Beta(\alpha,\beta+\gamma)$
