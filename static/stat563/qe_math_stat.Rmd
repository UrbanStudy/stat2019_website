...
### 2019SB2 
[2004F8][] [2007F4B][] [2013FB4][] [2015S3B][] [2018S1B][] [Laplace](#Laplace) [MLE](#MLE)
[7.E.13][]
...
### 2019SB3 
[2003S9][] [2004F9][] [2007F5B][] [2015S4B][] [2018S3B][] [SPower](#SPower) [power](#power) [UMP](#UMP)
...
#### 1.6.1 probability density function {#PDF} 
$F_X(x)=P_X(X= x)$
...
4.2.14$X\sim n(\mu,\sigma^2)$, $\perp\!\!\!\perp Y\sim n(\gamma,\tau^2)$
...
#### **Theorem 4.3.5** {#indep-2} 
Let X and Y be independent random variables. Let $g(x)$ be a function only of a; and $h(y)$ be a function only of y. Then the random variables $U=g(X)\perp\!\!\!\perp V=h(Y)$.
...
#### **Theorem 6.2.6 (Factorization Theorem)** {#Facto} 
...
#### **Theorem 6.2.24 (Basu's Theorem)** {#Basu} 
...
#### **Theorem 7.3.9 (Cramer-Rao Inequality)** {#CRLB} 
...
#### **Lemma 7.3.11 Fisher information** {#FishI} 
...
#### **Theorem 7.3. 17 (Rao-Blackwell)** {#Rao-Bla}
...
#### **Theorem 7.3.23 Lehmann-Scheffe** {#Lehm-Sche} 
...
#### **Definition 8.2.1 The likelihood ratio test** {#LRT} 
...
#### **Theorem 8.3.17 (Karlin-Rubin)** {#Kar-Rub} 
