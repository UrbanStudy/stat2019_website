...
### 2003S3
[2004F11][] [2007F3A][] [2008S2A][] [2009FA2][] [2010SA4][] [2015S1Ab][] [2016S5][] [2016F8][] [2018FA1][]
...
### 2003S7
[2008F5][] [2009SB1][] [2009FB4][] [2016S4][] [2016F7][] [2017FB4][] [2018FB2][] [2019SB4][] [MOM][7.2.1] [MLE](#MLE) [@effi] [CRLB][7.3.2]
...
### 2003F4
[@Pois] [MLE](#MLE) [CRLB][7.3.2] [suff][8.2.1]
...
### 2005S9
[2013FB5][] [2018FB4][] [@Unif] [MLE](#MLE) [suff][8.2.1]
...
### 2007F3A
[2003S3][] [2004F11][] [2008S2A][] [2010SA4][] [2015S1Ab][] [2016S5][] [2016F8][] [2018FA1][] [2019SA1 ][]
...
### 2007F2B
[2014F5B][] [2017FB2][] [@Unif] [HypoT](#HypoT) [power](#power)
...
### 2008S2A
[2003S3][] [2004F11][] [2007F3A][] [2009FA2][] [2010SA4][] [2015S1Ab][] [2016S5][] [2016F8][] [2018FA1][] [2019SA1 ][]
...
### 2008S4A
[2007F1A][] [2013FB1][] [@Norm] [unbias][7.3.1] [consi][10.1.1]
...
### 2009FA2
[2003S3][] [2004F11][] [2007F3A][] [2008S2A][] [2010SA4][] [2015S1Ab][] [2016S5][] [2016F8][] [2018FA1][] [2019SA1 ][]
...
### 2009FA4
[2008S1B][] [2015F1][] [@Unif] [@PDF] [@mean] [@Var] [consi][10.1.1]
...
### 2011S4
[2010SA3][] [2018FA4][] [@Pois] [LimD](#LimD)
...
### 2011F6
[2003F9][] [2011F6][] [@Pois] [UMP][8.3.2] [HypoT](#HypoT)
...
### 2013FB1
[2007F1A] [2008S4A] [@Norm] [MLE](#MLE) [suff][8.2.1] [consi][10.1.1] [unbias][7.3.1]
...
### 2013FB2
[2007F5A][] [2014F1B][] [2015S1B][] [@CDF] [MLE](#MLE)
...
### 2014SB5
[@Bino] [@Unif] [BayesE](#BayesE) [MLE](#MLE)
...
### 2014F1B
[2007F5A][] [2013FB2][] [2015S1B][] [@CDF] [MLE](#MLE) [@CI]
...
### 2015S1Ab
[2003S3][] [2004F11][] [2007F3A][] [2008S2A][] [2010SA4][] [2016S5][] [2016F8][] [2018FA1][] [2019SA1][]
...
### 2016S5
[2003S3][] [2004F11][] [2007F3A][] [2008S2A][] [2010SA4][] [2015S1Ab][] [2016F8][] [2018FA1][] [2019SA1 ][]
...
### 2016F8
[2003S3][] [2004F11][] [2007F3A][] [2008S2A][] [2009FA2][] [2010SA4][] [2015S1Ab][] [2016S5][] [2018FA1][] [2019SA1][]
...
### 2018FA1
[2003S3][] [2004F11][] [2007F3A][] [2008S2A][] [2009FA2][] [2010SA4][] [2015S1Ab][] [2016S5][] [2016F8][] [2019SA1 ][]
...
### 2018FB3
[UMVUE][7.3.2] [FishI][7.3.2] [perc](#perc)
...
### 2019SA1 
[2003S3][]  [2004F11][] [2007F3A][] [2008S2A][] [2009FA2][] [2010SA4][] [2015S1Ab][] [2016S5][] [2016F8][] [2018FA1][]
...
|   $D$   |$E;V;EX^2$|$f(x);F(x)$|$MLE;T;I$|$M_x(t);M'(t);M''(t);M^n(t)$|
|   -    |     ---  |   ---   |    --   | ---- |
|$Bern(p)$|$p$;$p$;$pq$|$p^xq^{1-x},x=1,0$|$\bar X$;$\sum x_i\sim Bino(np)$;$n/\theta(\theta-1)$|$pe^t+q$|
|$Bino(n,p)$|$np$;$np(np+q)$;$npq$|$\binom{n}{x}p^x q^{n-x}$,$x=0,1..n$;$I_{1-p}(n-x,x+1)$||$(pe^t+q)^n$|
...
|$NBino(r,p)$|$r/p$; ;$rq/p^2$|$\binom{x-1}{r-1}p^rq^{x-r}$,$x=r,r+1..$||$(\frac{pe^t}{1-qe^t})^r$|
|$HGeom(N,m,k)$|$\frac{km}N$; ;$\mu\frac{(N-m)(N-k)}{N(N-1)}$|${\binom{m}{x}\binom{N-m}{k-x}}/{\binom{N}{k}}$|
|$Pois(\mu)$|$\mu$;$\mu$;$\mu^2+\mu$|$\frac{\mu^x}{x!}e^{-\mu}$,$x=0,1..$;$e^{-\mu}\sum_{i=0}^x\frac{\mu^i}{i!}$|$\bar X$;$\sum x_i$;$n/\mu$|$e^{\mu(e^t-1)}$;$\mu e^tM(t)$;$\mu e^t(1+\mu e^t)M(t)$|
|$Unif(n)$|$\frac{n+1}2$;$\frac{(n+1)(2n+1)}{6}$;$\frac{(n^2-1)}{12}$|$\frac{1}n$,$x=1,2..n$||$\sum_{i=1}^n{e^{ti}}/n$|
|$Unif(a,b)$|$\frac{a+b}{2}$; ;$\frac{(b-a)^2}{12}$|$\frac{1}{b-a}$,$x\in(a,b)$;$\frac{x-a}{b-a}$||$\frac{e^{tb}-e^{ta}}{t(b-a)}$|
...
|$LNorm(\mu,\sigma^2)$|$e^{\mu+\frac{\sigma^2}2}$;$e^{2\mu+2\sigma^2}$;$E^2X(e^{\sigma^2}-1)$|$\frac{1}{x\sigma \sqrt{2\pi}}e^{\frac{-(\ln x-\mu)^2}{2\sigma^2}}$||$e^{n\mu+n^2\sigma^2/2}$|
|$Cauchy(\theta,\sigma^2)$||$\frac{1}{\pi\sigma}\frac1{1+(\frac{x-\theta}{\sigma})^2}$|||
|$DExpo(\mu,\sigma^2)$|$\mu$;$\mu^2+2\sigma^2$;$2\sigma^2$|$\frac{1}{2\pi\sigma} e^{-|\frac{x-\mu}{\sigma}|}$||$\frac{e^{\mu t}}{1-\sigma^2t^2}$|
...
|$Gamm(\alpha,\beta)$|$\alpha\beta$; ;$\alpha\beta^2$;|$\frac{1}{\Gamma(a)\beta^{\alpha}}x^{a-1}e^{-x/\beta}$||$(\frac{1}{1-\beta t})^a, t <\frac1\beta$|
...
|$\chi_p^2$|$p$;$2p+p^2$;$2p$|$\frac{x^{\frac{p}2-1}}{\Gamma \frac{p}2 2^{\frac{p}2}}e^{-\frac{x}2}$|;$\sum\ln x_i$;|$(1-2t)^{-p/2}, t<\frac12$|
