...
$$\hat y=\hat\beta_0+\hat\beta_1x \sim$$

Similarly,

$$\hat y_0|x_0=\hat y_0=\hat\beta_0+\hat\beta_1x_0 \sim$$

$$\frac{\hat y_0|x_0-(\hat\beta_0+\hat\beta_1x_0)}{se(\hat y_0|x_0)}=\frac{\hat y_0-\bar y_0}{se(\hat y_0)}= \sim$$
