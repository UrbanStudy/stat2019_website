...
---|---|---|---|---|---|---|---
Var()|$\sigma_x^2$|$\sigma^2$|$\sigma^2$|$\times$|$\frac{\sigma^2}{(n-1)S_x^2}$|$\sigma^2(\frac1n+\frac{\bar x^2}{(n-1)S_x^2})$|
Cov()|$\sigma_x^2$|   $0$    |   $0$    | $\sigma_{xy}$|$\sigma^2(X'X)^{-1}$| $MSE\cdot C_{11}$
Cor()|            |          |          | $r$ |
