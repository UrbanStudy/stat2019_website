...
|SS|=|df|MS|
|---|---|---|---|---
|SST|$\sum_{i=1}^n(y_i-\bar y)^2$     |n-1| MST |
|SSR|$\sum_{i=1}^n(y_i-\hat y_i)^2$   |2-1| MSR | $\hat\beta_1S_{xy}=\hat\beta_1^2S_{xx}$
|SSE|$\sum_{i=1}^n(\hat y_i-\bar y)^2$|n-2| MSE |
...
$$SST=S_{yy}=\sum_{i=1}^n(y_i-\bar y)^2=\sum_{i=1}^n[(\beta_0+\beta_1x_i+\varepsilon_i)-\frac1n\sum_{i=1}^n(\beta_0+\beta_1x_i+\varepsilon_i)]^2=\sum_{i=1}^n[\beta_1(x_i-\bar x)+(\varepsilon_i-\bar\varepsilon_i)]^2$$
