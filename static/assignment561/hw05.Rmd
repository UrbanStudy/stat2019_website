...
# failed attempt:
# uniroot(function(k)(dhyper(0, 6, 94, k, log = FALSE)-0.1), lower=0, upper=100)$root

# use function of qhyper
uniroot(function(k)(qhyper(0.1, 6, 94, k, lower.tail = TRUE, log.p = FALSE)-0.1), lower=0, upper=100)$root

# use function of algebra
