...
# by bisection method
# when lambda down to 6, a randomly chosen cookie only has one chocolate chip on 0.01 probability.
qpois(0.01, 6, lower.tail = TRUE, log.p = FALSE)
curve(qpois(0.01, x, lower.tail = TRUE, log.p = FALSE), from=0,to=10); text(6.64,0, "6.638351"); abline(v = 6.638351, lty = 3)
