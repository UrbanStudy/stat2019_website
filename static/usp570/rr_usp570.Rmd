...
Not only PT and AC, but many variables such as gender, race, and income level may not be independent. This study checks the colinearity but doesn't report the details. A factorial design might help to identify the interaction effects among the chosen factors. The nonparametric test could work for dependent factors. Some checks of normality, residual, and variances could help to improve the study design too.
