...
\hypertarget{the-first-probit-model}{%
\paragraph{The first Probit model}\label{the-first-probit-model}}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{M <-}\StringTok{ }\DecValTok{25000}\NormalTok{; }\KeywordTok{set.seed}\NormalTok{(}\DecValTok{123}\NormalTok{)}
...
\NormalTok{gibbs <-}\StringTok{ }\KeywordTok{matrix}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\DataTypeTok{ncol=}\NormalTok{p,}\DataTypeTok{nrow=}\DecValTok{1000}\NormalTok{); Z<-}\KeywordTok{matrix}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\DecValTok{1000}\NormalTok{,n) }\CommentTok{#For Sub Sample}
...
\ControlFlowTok{if}\NormalTok{(m}\OperatorTok{%%}\NormalTok{(M}\OperatorTok{/}\DecValTok{1000}\NormalTok{)}\OperatorTok{==}\DecValTok{0}\NormalTok{) \{ gibbs[m}\OperatorTok{/}\NormalTok{(M}\OperatorTok{/}\DecValTok{1000}\NormalTok{),] <-}\StringTok{ }\KeywordTok{t}\NormalTok{(beta); Z[m}\OperatorTok{/}\NormalTok{(M}\OperatorTok{/}\DecValTok{1000}\NormalTok{),]<-}\StringTok{ }\NormalTok{z\}   }\CommentTok{# subsamples of equal size}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{note_stat501_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\CommentTok{## [1,] 0.9661 0.9711 0.9146 0.5592 0.9468 0.9633 0.2758 0.7201 0.3568 0.268 0.2762 0.8524 0.9023  0.91 0.9793 0.9259 0.982 0.561 0.6922 0.8849 0.6189 0.5728 0.6842 0.7264 0.8487 0.5139 0.8284 0.738 0.713 0.449 0.842  0.64 0.7557 0.8421 0.8189 0.9577 0.738 0.6861 0.7493}
\end{Highlighting}
\end{Shaded}

\hypertarget{the-second-probit-model-refer-to-hoff-2009-ch.12}{%
\paragraph{The second Probit model, refer to (Hoff, 2009,
Ch.12)}\label{the-second-probit-model-refer-to-hoff-2009-ch.12}}
...
\NormalTok{BETA<-}\KeywordTok{matrix}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\DecValTok{1000}\NormalTok{,p) ; Z<-}\KeywordTok{matrix}\NormalTok{(}\OtherTok{NA}\NormalTok{,}\DecValTok{1000}\NormalTok{,n) ; ac<-}\DecValTok{0}
\NormalTok{mu<-}\DecValTok{0}\NormalTok{ ; sigma<-}\DecValTok{100}  \CommentTok{### Why????}

\CommentTok{## MCMC}
\NormalTok{S<-}\DecValTok{25000}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ZPM<-}\KeywordTok{apply}\NormalTok{(Z,}\DecValTok{2}\NormalTok{,mean)}
...
\begin{center}\includegraphics{note_stat501_files/figure-latex/unnamed-chunk-15-1} \end{center}
...
\begin{center}\includegraphics{note_stat501_files/figure-latex/unnamed-chunk-18-1} \includegraphics{note_stat501_files/figure-latex/unnamed-chunk-18-2} \end{center}
...
\includegraphics{note_stat501_files/figure-latex/unnamed-chunk-19-1.pdf}
\includegraphics{note_stat501_files/figure-latex/unnamed-chunk-19-2.pdf}
\includegraphics{note_stat501_files/figure-latex/unnamed-chunk-19-3.pdf}
