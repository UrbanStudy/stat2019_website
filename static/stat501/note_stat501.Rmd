...
\[\begin{align} 
\boldsymbol{\omega|\beta}  &\sim PG(1,\boldsymbol{|X'\beta|}) \\ 
\boldsymbol{\beta|Y,\omega}&\sim N_p(\boldsymbol{\mu,\Sigma}) \\ 
\boldsymbol{\mu}&=\boldsymbol{\Sigma X'\Omega\eta} & \boldsymbol{\Omega}&=diag_n(\mathbf{\omega}) & \boldsymbol{\eta}&=\mathbf{\Omega^{-1}}(\mathbf{Y}-\frac12)\\
\boldsymbol{\Sigma}&=\boldsymbol{\sigma^{-1}+X'\Omega X} & \boldsymbol{\sigma}&=diag_p(100) &\\
\end{align}\]
