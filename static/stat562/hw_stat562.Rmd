...
Therefore, $T(\prod_{i=1}^nx_i,\sum\limits_{i=1}^nx_i)$ is a sufficient statistic for $(\alpha,\beta)$
...
Let $Y_1 = \lnX_1$ and $Y_2 =\lnX_2$. Then $Y_1$ and $Y_2$ are iid and, by Theorem 2.1.5, the pdf of each is
