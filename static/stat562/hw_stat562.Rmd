...
```{r echo=FALSE, out.width='30%',collapse=T, fig.show='hold'}
...
$=-\frac{(\tau^2+\frac{\sigma^2}n)^2\theta^2-2(\tau^2\bar x+\frac{\sigma^2}n\mu)(\tau^2+\frac{\sigma^2}n)\theta+(\tau^4\bar x^2+\frac{\sigma^4}{n^2}\mu^2+2\tau^2\frac{\sigma^2}n\bar x\mu)(-2\tau^2\frac{\sigma^2}n\bar x\mu+\tau^2\frac{\sigma^2}n\bar x^2+\tau^2\frac{\sigma^2}n\mu^2)}{2\tau^2\frac{\sigma^2}n(\tau^2+\frac{\sigma^2}n)}$
