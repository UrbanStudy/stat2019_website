...
where the parameters $\alpha$ and $\beta$ are positive.
 ...
 (a). Find a tW<rdimensional sufficient statistic for ($\alpha,\beta$).
 
 (b). Find the MLEs of $\alpha$ and $\beta$.
 
 (c). The length (in millimeters) of cuckoos' eggs found in hedge sparrow nests can be modeled with this distribution. For the data $22.0, 23.9, 20.9, 23.8, 25.0, 24.0, 21 .7, 23.8, 22.8, 23. 1, 23. 1 , 23.5, 23.0, 23.0$, find the MLEs of $\alpha$ and $\beta$.

 ---

**7.11** Let $X_1,..,X_n$, be iid with pdf $f(x|\theta)=\theta x^{\theta-1}$, where $0\le x\le1,0<\theta<\infty$


 (a). Find the MLE of $\theta$, and show that its variance $n\to0$ as $n\to\infty$.
