...
$$f(x_1,..,x_n)=\frac{n!a^n}{\theta^{an}}x_1^{a-1}\cdots x_n^{a-1}, 0<x_1<..<x_n<\theta$$
...
$$\therefore f_{Y_1..Y_n}(y_1,..,y_n)=\begin{cases}iay_i^{ia−1}&0<y_i<1,i=1,2,..,n−1\\\frac{an}{\theta^{an}}y_n^{an-1}& 0<y_n<\theta \end{cases}$$
