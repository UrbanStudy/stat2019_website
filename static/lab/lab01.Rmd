...
$$So\quad E(\hat{\beta_0})=\sum_{i-1}^n(\frac1n-\overline XC_i)E(\beta_0+\beta_1X_i+\epsilon_i)=\sum_{i=1}^n[\frac1nE(\beta_0+\beta_1X_i+\epsilon_i)-\overline XC_iE(\beta_0+\beta_1X_i+\epsilon_i)]$$ 
