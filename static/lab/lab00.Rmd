---
title: 'STAT564 Lab 0: Introduction to Rfor Simple Linear Regression Analysis'
author: "Shen Qu"
date: "9/21/2018"
output: 
  html_document:
...
plot(TVads$Spend, TVads$MilImp, pch=16, xlab = "TV advertising budget, 1983 ($ millions) ", ylab = "Millions of retained impressions per week")
```
Figure 1: Scatterplot of Millions of retained impressions per week and TV advertising budget.
...
```{r, echo=TRUE}
plot(TVads$Spend, TVads$MilImp, pch=16, xlab = "TV advertising budget, 1983 ($ millions) ", ylab = "Millions of retained impressions per week") # Create the scatterplot
abline(model, col = "red", lwd= 3) # Draw the fitted line #
```
Figure 2: Fitted rgeression model oevrlayed on the scatterplot of Millions of retained impressions per week and TV advertising budget.
