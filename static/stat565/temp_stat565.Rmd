...
|RB-RCBD|$\frac{(b-1)(\sigma_{\beta}^2+\sigma^2)}b$|$+0=$|$\frac{(\sigma_{\beta}^2+\sigma^2)(b-1)}b$|
...
|FB-RCBD|$\frac{(b+1)\sigma_{\tau}^2}{b}-\frac{\sigma^2}{ab}$|$+\tau_i^2=$|$\frac{(a-1)\sigma^2}{ab}+\tau_i^2$|
