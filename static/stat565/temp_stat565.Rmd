...
|FB-RCBD|$\sigma_{\beta}^2+\frac{(b-1)\sigma^2}b$  |$+\beta_{j}^2=$|$\frac{(b-1)\sigma^2}b+\beta_{j}^2$|
|RB-RCBD|$\frac{(\sigma_{\beta}^2+\sigma^2)(b-1)}b$|$+0=$|$\frac{(\sigma_{\beta}^2+\sigma^2)(b-1)}b$|
...
|FB-RCBD|$\frac{(b+1)\sigma_{\tau}^2}{b}-\frac{\sigma^2}{ab}$|$+\tau_i^2=$|$\frac{(b-1)\sigma^2}{ab}+\tau_i^2$|
...
| ---   |   ---               |---|---|
|FB-RCBD|$\sigma_{\tau}^2+\frac{(a-1)\sigma^2}a$|$+\tau_i=$|$\frac{(a-1)\sigma^2}a$|
...
| ---   |   ---               |---|---|
|FB-RCBD|$\frac{(a+1)\sigma_{\beta}^2}{a}-\frac{\sigma^2}{ab}$|$+\beta_{j}^2=$|$\frac{(b-1)\sigma^2}{ab}+\beta_{j}^2$|
|RB-RCBD|$\frac{(a+1)\sigma_{\beta}^2}{a}-\frac{\sigma^2}{ab}$|$+=$|$\frac{(b-1)(a\sigma_{\beta}^2+\sigma^2)}{ab}$|

|$E[(y_{ij}-\bar y_{i.}-\bar y_{.j}+\bar y_{..})^2]$|$=Var[y_{ij}-\bar y_{i.}-\bar y_{.j}+\bar y_{..}]$|$+E[y_{ij}-\bar y_{i.}-\bar y_{.j}+\bar y_{..}]^2$|$=$|
| ---   |   ---               |---|---|
|FB-RCBD|$\frac{(ab-a-b-1)\sigma^2}{ab}$|$+0=$|$\frac{(a-1)(b-1)\sigma^2}{ab}$|
