...
$=\sigma_{\beta}^2+\sigma^2+\frac{\sigma^2}b-\frac{2\sigma^2}b=\sigma_{\beta}^2+\frac{(b-1)\sigma^2}b$

RB-RCBD

$Var[\beta_{j}-\frac{\sum_{j=1}^b\beta_{j}}b+ε_{ij}-\frac{\sum_{j=1}^bε_{ij}}b]=$,
$Var[\beta_{j}]+\frac{\sum_{j=1}^bVar[\beta_{j}]}{b^2}+Var[ε_{ij}]+\frac{\sum_{j=1}^bVar[ε_{ij}]}{b^2}-\frac{2Cov[\beta_{j},\sum_{j=1}^b\beta_{j}]}b+2Cov[\beta_{j},ε_{ij}]-\frac{2Cov[\beta_{j},\sum_{j=1}^bε_{ij}]}b-\frac{2Cov[\sum_{j=1}^b\beta_{j},ε_{ij}]}b+\frac{2Cov[\sum_{j=1}^b\beta_{j},\sum_{j=1}^bε_{ij}]}{b^2}-\frac{2Cov[ε_{ij},\sum_{j=1}^bε_{ij}]}b$,
...
|FB-RCBD|$\sigma_{\beta}^2+\frac{(b-1)\sigma^2}b$  |$+\beta_{j}=$|$\sigma_{\beta}^2+\frac{(b-1)\sigma^2}b+\beta_{j}$|
|RB-RCBD|$\frac{(\sigma_{\beta}^2+\sigma^2)(b-1)}b$|$+\beta_{j}=$|$\frac{(\sigma_{\beta}^2+\sigma^2)(b-1)}b+\beta_{j}$|

|$E[(\bar y_{i.}-\bar y_{..})^2]$|$=Var[\bar y_{i.}-\bar y_{..}]$|$+E[\bar y_{i.}-\bar y_{..}]^2$|$=$|
| ---   |   ---               |---|---|
|FT-CRD |$\frac{(n+1)\sigma_{\tau}^2}{n}-\frac{\sigma^2}{an}$| $+\tau_i=$ |$\frac{(n+1)\sigma_{\tau}^2}{n}-\frac{\sigma^2}{an}+\tau_i$|
|RT-CRD |$\frac{(n\sigma_{\tau}^2+\sigma^2)(n-1)}{an}$| $+\tau_i=$ |$\frac{(n\sigma_{\tau}^2+\sigma^2)(n-1)}{an}+\tau_i$|
|FB-RCBD|$\frac{(b+1)\sigma_{\tau}^2}{b}-\frac{\sigma^2}{ab}$|$+\tau_i=$|$\frac{(b+1)\sigma_{\tau}^2}{b}-\frac{\sigma^2}{ab}+\tau_i$|
|RB-RCBD|$\frac{(b+1)\sigma_{\tau}^2}{b}-\frac{\sigma^2}{ab}$|$+\tau_i=$|$\frac{(b+1)\sigma_{\tau}^2}{b}-\frac{\sigma^2}{ab}+\tau_i$|

|$E[(y_{ij}-\bar y_{.j})^2]$|$=Var[y_{ij}-\bar y_{.j}]$|$+E[y_{ij}-\bar y_{.j}]^2$|$=$|
| ---   |   ---               |---|---|
|FB-RCBD|$\sigma_{\tau}^2+\frac{(a-1)\sigma^2}a$|$+\tau_i=$|$\sigma_{\tau}^2+\frac{(a-1)\sigma^2}a+\tau_i$|
|RB-RCBD|$\sigma_{\tau}^2+\frac{(a-1)\sigma^2}a$|$+\tau_i=$|$\sigma_{\tau}^2+\frac{(a-1)\sigma^2}a+\tau_i$|

|$E[(\bar y_{.j}-\bar y_{..})^2]$|$=Var[\bar y_{.j}-\bar y_{..}]$|$+E[\bar y_{.j}-\bar y_{..}]^2$|$=$|
| ---   |   ---               |---|---|
|FB-RCBD|$\frac{(a+1)\sigma_{\beta}^2}{a}-\frac{\sigma^2}{ab}$|$+\beta_{j}=$|$\frac{(a+1)\sigma_{\beta}^2}{a}-\frac{\sigma^2}{ab}+\beta_{j}$|
|RB-RCBD|$\frac{(a+1)\sigma_{\beta}^2}{a}-\frac{\sigma^2}{ab}$|$+\beta_{j}=$|$\frac{(a+1)\sigma_{\beta}^2}{a}-\frac{\sigma^2}{ab}+\beta_{j}$|

|$E[(y_{ij}-\bar y_{i.}-\bar y_{.j}+\bar y_{..})^2]$|$=Var[y_{ij}-\bar y_{i.}-\bar y_{.j}+\bar y_{..}]$|$+E[y_{ij}-\bar y_{i.}-\bar y_{.j}+\bar y_{..}]^2$|$=$|
| ---   |   ---               |---|---|
|FB-RCBD|$\frac{(ab-a-b-3)\sigma^2}{ab}$|$+0=$|$\frac{(ab-a-b-3)\sigma^2}{ab}$|
