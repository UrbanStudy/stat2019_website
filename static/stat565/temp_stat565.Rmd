...
|FT-CRD |$\frac{(n+1)\sigma^2}{n}$| $\tau_i^2$ |$\frac{(a-1)\sigma^2}{an}+\tau_i^2$|
...
|$\sum_{i=1}^aε_{ij}$||$\sigma^2$|$\sigma^2$|$a\sigma^2$|
|$\sum_{j=1}^bε_{ij}$|||$\sigma^2$|$b\sigma^2$|
|$\sum_{i=1}^a\sum_{j=1}^bε_{ij}$||||$\sigma^2$|
