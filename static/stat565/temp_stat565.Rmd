...
$$\bar y_{i.}\pm t_{\frac{\alpha}2,N-a}\sqrt\frac{MS_E}n=-21\pm t_{\frac{0.01}2,18-3}\sqrt\frac{15.6}5$$
  
The 99% confidence interval on the mean difference between the lives of battery brands 2 and 3 is:

$$\bar y_{i.}-\bar y_{j.}\pm t_{\frac{\alpha}2,N-a}\sqrt\frac{2MS_E}n=79.4-100.4\pm t_{\frac{0.05}2,18-3}\sqrt\frac{2*15.6}5$$
