...
ggplot(table_ingredients,aes(Batch,y))+geom_point(aes(shape=Day,col=Trt),alpha=0)+geom_text(aes(label=Day))+scale_colour_grey()+facet_grid(.~Trt)+theme_light()
```
...
glimpse(table_ingredients)
ggplot(table_ingredients,aes(Day,y))+geom_point(aes(shape=Batch))+scale_colour_grey()+facet_grid(.~Trt)+theme_light()
```
