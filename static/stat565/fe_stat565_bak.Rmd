...
kable(summary(contrast(lsmeans(lm(Percent~hd, table_sagebrush),'hd'),list(c32_12.22=c(rep(0,3),-0.5,-0.5,1,rep(0,15)))), adjust="tukey"))%>%kable_styling("condensed",full_width=F)
```
