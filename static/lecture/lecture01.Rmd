...
{.table .table-condensed .table-striped .text-center}
...
Question:If LHS is to the at least .95, then what must each $P(A_i)$ be to guarantee that?
#### 9.  
   .95=np-(n-1)
   .95+n-1=np
   n-0.5=np
