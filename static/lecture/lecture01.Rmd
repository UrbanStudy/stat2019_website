...
1. Definition: A and B are disjiont or mutually exclusive, if $A\cup B=\emptyset$

1. Let B be a subset of all possible subset of S. Then B is a *Borel field*, if
...
let B be a **Borel field**. Then P is a _probability set_ `function` if
