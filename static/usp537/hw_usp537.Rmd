...
The monopolist won't make a profit. To examine the efficiency, we should compare total cost with total revenue and total surplus. 

If the price is set to $P^*=0.5$, the total benefit is $TS+TR-TC=451250+(0.5-0.5)95000-250000=\$201250$

If the price is set to $P_m=5.25$, the total benefit is $TS+TR-TC=338437.5-24375=\$314062.5$
