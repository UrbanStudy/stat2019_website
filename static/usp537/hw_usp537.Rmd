...
```{r echo=FALSE}
plot(c(0,40000), c(0,0.4), type = "n",xlab ="#Off-Peak rail trips", ylab ="Off-Peak fare")
...
plot(c(0,5), c(0,5), type = "n",xlab ="#Off-Peak rail trips", ylab ="Off-Peak fare",xaxs = "i",yaxs = "i")
...
arrows(sqrt(8),1.2,2.2,1.9, length = 0.1, code = 2, col ="blue", lty = 4)
arrows(1.2,1.3,1.8,1.9, length = 0.1, code = 1, col ="blue", lty = 4)
```
