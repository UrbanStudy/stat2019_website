...
library(gghalfnorm)
gghalfnorm(x =model_2015f2$coefficients[2:8],labs = names(model_2015f2$coef) , nlab = 8)+ ggplot2::theme_light()
...
library(gghalfnorm)
gghalfnorm(x =model_2018f2$coefficients[2:8],labs = names(model_2018f2$coef) , nlab = 5)+ ggplot2::theme_light()
