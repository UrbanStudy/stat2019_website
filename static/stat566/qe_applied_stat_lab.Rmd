...
```{r, eval=F, include=T}
model_2016s1 <- lm(weight~height+age+male,table_2016s1)
summary(model_2016s1)


aic_2016s1<- MASS::stepAIC(model_2016s1,~.^2,direction = "both")
summary(aic_2016s1)
anova(aic_2016s1)

model_2016s1_log <- update(model_2016s1,log(weight)~.)
summary(model_2016s1_log)
plot(model_2016s1_log)

aic_2016s1_log<- MASS::stepAIC(model_2016s1_log,~.^2,direction = "both")
summary(aic_2016s1_log)
anova(aic_2016s1_log)

boxcox_2016s1 <-  MASS::boxcox(model_2016s1)
boxcox_2016s1$x[which.max(boxcox_2016s1$y)]
model_2016s1_sq.inv <- update(model_2016s1,weight^(-0.5)~.)
summary(model_2016s1_sq.inv)
anova(model_2016s1_sq.inv)
plot(model_2016s1_sq.inv)

(predict(model_2016s1_sq.inv,data.frame(height=70,age=26,male="male"),interval = "prediction", level = 0.95))^{-2}
```
...
model_2016s1_1 <- lm(weight~height+age,data_male)
summary(model_2016s1_1)
plot(model_2016s1_1)
boxcox_2016s1_1 <- MASS::boxcox(model_2016s1_1)
boxcox_2016s1_1$x[which.max(boxcox_2016s1_1$y)]
model_2016s1_3 <- update(model_2016s1_1,weight^1.5~.)
summary(model_2016s1_3)
plot(model_2016s1_3)
anova(model_2016s1_3)

model_2016s1_2 <- lm(weight~height+age,data_female)
summary(model_2016s1_2)
plot(model_2016s1_2)
boxcox_2016s1_2 <-  MASS::boxcox(model_2016s1_2)
boxcox_2016s1_2$x[which.max(boxcox_2016s1_2$y)]
model_2016s1_4 <- update(model_2016s1_2,weight^0.5~.)
summary(model_2016s1_4)
plot(model_2016s1_4)
anova(model_2016s1_4)
...
```{r,eval=F,message=F}
library(lme4)
model_2016s2_3 <-lmer(y~machine/(1|power)*station,table_2016s2)
model_2016s2_4 <-lmer(y~machine*station+(1|machine/power)+(1|machine/power):station,table_2016s2)
...
model_2016s2_5 <- aov(y~machine_f*station_f+power_r%in%machine_f+power_r%in%machine_f*station_f, table_2016s2)
gad(model_2016s2_5)
```
