...
fit_x5<- lm(pop_largest_city~population+land_area_skm+pop_density+confirmed.double+life_expectancy+gdp_capita,table_2020s1)
predict(fit_x5, table_2020s1[c(2,11,25,29,31,33,36,43,46),], interval="prediction")
imputed$imp$pop_largest_city
```
