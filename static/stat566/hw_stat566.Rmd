...
write the model you would fit for these data, then fit the model and report the complete ANOVA table and then write the conclusions along with p values.
