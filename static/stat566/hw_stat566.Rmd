...
Based on the results before, factor AB, AC, BC have significant interactive effects. We find when black-and-white brochures or \$19.95 price applied, the 3rd class have more orders than 1st (average 5, 6.75 more orders). When 1rd class or color brochures price applied, the \$24.95 price have more orders than \$19.95 (average 8 or 6.5 more orders). We recommend two combinations: 3rd class mail with black-and-white brochures and \$19.95 price; or 1st class mail with color brochures and \$24.95 price, which focus on different consumer groups. Some economic consumers prefer simple decor and preferential price. Meanwhile, some are easier be impressed by exquisite packaging and price insensitive. The two combinations can cover the two consumer groups best.
