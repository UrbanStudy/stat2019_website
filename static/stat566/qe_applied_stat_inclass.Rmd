...
Process 1: $y_i=\beta_0+\beta_1x_i+\varepsilon_i$; Process 2: $y_i=\gamma_0+\gamma_1x_i+\varepsilon_i$;
...
To test the hypothesis that the two lines have different intercepts and a common slope $(H_0:\gamma_1=0)$,
...
$SSR(X_3,X_4,X_5)=SSR(X_1,X_2,X_3,X_4,X_5)-SSR(X_1,X_2,X_3,X_4,X_5)=29+41+26=96$

$F_{\nu_1=3,\nu_2=71}(\frac{96}{607})$, $F_{\nu_1=3,\nu_2=50}(2.70)=0.05$, $F_{\nu_1=3,\nu_2=100}(2.61)=0.05$


(b) Calculate $R^2$ for the model $y_i=\beta_0+\beta_1x_{i1}+\beta_3X_{i2}\varepsilon_i$

$R^2=\frac{SSR}{SST}=1-\frac{SSE}{SST}=\frac{271}{703}$
...
$F\frac{(20647+663.87250)/2}{703.87576/9}=136.244$
...
$F=\frac{(20647-703.87576)/1}{78.20842}=255$; 
...
Output Statistics
 ...
 Obs distance Value     MeanPredict 95% CL   Mean
 
 1   162.5000
 
 2   144.0000 141.2810  4.8755      130.5501 152.0119
 
 3   147.5000 177.3879  8.1998      159.3402 195.4355
 
 4   163.5000 159.3344  5.2769      147.7201 170.9488
 
 5   192.0000
 
 6   171.7500 150.3077  4.6253      140.1274 160.4880
 
 7   162.0000
 
 8   104.8300 114.2008  9.1584       94.0433 134.3583
 
 9   105.6700 123.2276  7.4170      106.9028 139.5523
 
 10  117.5800 132.2543  5.9141      119.2374 145.2712
 
 11  140.2500 123.2276  7.4170      106.9028 139.5523
 
 12  150.1700 141.2810  4.8755      130.5501 152.0119
 
 13  165.1700 159.3344  5.2769      147.7201 170.9488
 ----------------------------------------------------
 ...
 2   103.2332 179.3288 2.7190
 
 3   136.6668 218.1089 -29.8879
 
 4   121.0281 197.6408 4.1656
 
 5
 
 6   112.4115 188.2039 21.4423
 
 7
 
 8   72.5018  155.8999 -9.3708
 
 9   83.2403  163.2148 -17.5576
 
 10  93.4996  171.0089 -14.6743
 
 11  83.2403  163.2148 17.0224
 
 12  103.2332 179.3288 8.8890
 
 13  121.0281 197.6408 5.8356
 ------------------------------ 
...
WorkshopB: $y_i=\gamma_0+\gamma_1x_i+\varepsilon_i$,$5\le i\le8$;

WorkshopC: $y_i=\gamma_0+\gamma_1x_i+\varepsilon_i$,$9\le i\le12$;

Let $w_{1i}=\begin{cases}1& 1\le i\le4\\0& 5\le i\le8\\0&9\le i\le12\end{cases}$, $w_{2i}=\begin{cases}0& 1\le i\le4\\1& 5\le i\le8\\0&9\le i\le12\end{cases}$, $w_{3i}=\begin{cases}0& 1\le i\le4\\0& 5\le i\le8\\1&9\le i\le12\end{cases}$

overall $y_i=w_{1i}(\beta_0+\beta_1x_i)+w_{2i}(\gamma_0+\gamma_1x_i)+w_{3i}(\delta_0+\delta_1x_i)+\varepsilon_i$

b) Write the matrix form of the appropriate model. Show the contents and dimensions of all matrices.

$$\begin{bmatrix} 70\\70\\68\\72\\75\\74\\72\\71\\72\\72\\73\\73\end{bmatrix}_{12\times1}=\begin{bmatrix} 1&58&0&0&0&0\\1&62&0&0&0&0\\1&60&0&0&0&0\\1&65&0&0&0&0\\0&0&1&60&0&0\\0&0&1&62&0&0\\0&0&1&60&0&0\\0&0&1&60&0&0\\0&0&0&0&1&66\\0&0&0&0&1&62\\0&0&0&0&1&61\\0&0&0&0&1&65\end{bmatrix}_{12\times6}\times
...
$H_0: \gamma_1=\delta_1=0$, $y_i=w_{1i}\beta_0+\beta_1x_i+w_{2i}\gamma_0+w_{3i}\delta_0+\varepsilon_i$, 

$w_{1i}=\begin{cases}1& 1\le i\le4\\0& 5\le i\le8\\0&9\le i\le12\end{cases}$, $w_{2i}=\begin{cases}0& 1\le i\le4\\1& 5\le i\le8\\0&9\le i\le12\end{cases}$, $w_{3i}=\begin{cases}0& 1\le i\le4\\0& 5\le i\le8\\1&9\le i\le12\end{cases}$

$$\begin{bmatrix} 70\\70\\68\\72\\75\\74\\72\\71\\72\\72\\73\\73\end{bmatrix}_{12\times1}=\begin{bmatrix} 1&58&0&0\\1&62&0&0\\1&60&0&0\\1&65&0&0\\0&60&1&0\\0&62&1&0\\0&60&1&0\\0&60&1&0\\0&66&0&1\\0&62&0&1\\0&61&0&1\\0&65&0&1\end{bmatrix}_{12\times4}\times
...
Process A: $y_i=\beta_0+\beta_1x_i+\varepsilon_i$; Process B: $y_i=\gamma_0+\gamma_1x_i+\varepsilon_i$;
...
$$\begin{bmatrix} 38\\55\\40\\45\\36\\30\\42\\30\\30\\41\end{bmatrix}_{10\times1}=\begin{bmatrix} 1&70&0&0\\1&70&0&0\\1&68&0&0\\1&72&0&0\\1&72&0&0\\1&75&1&75\\1&74&1&74\\1&72&1&72\\1&71&1&71\\1&73&1&73\\\end{bmatrix}_{10\times4} 
\begin{bmatrix} \beta_0 \\ \beta_1 \\ \gamma_0 \\ \gamma_1 \end{bmatrix}_{4\times1}
...
$$\begin{bmatrix} 38\\55\\40\\45\\36\\30\\42\\30\\30\\41\end{bmatrix}_{10\times1}=\begin{bmatrix} 1&70&0\\1&70&0\\1&68&0\\1&72&0\\1&72&0\\1&75&1\\1&74&1\\1&72&1\\1&71&1\\1&73&1\\\end{bmatrix}_{10\times3}\times
\begin{bmatrix} \beta_0 \\ \beta_1 \\ \gamma_0\end{bmatrix}_{3\times1}
+\begin{bmatrix} \varepsilon_1\\\varepsilon_2\\\varepsilon_3\\\varepsilon_4\\\varepsilon_5\\\varepsilon_6\\\varepsilon_7\\\varepsilon_8\\\varepsilon_9\\\varepsilon_{10}\end{bmatrix}_{10\times1}$$
