...
A & B & C & D & E & F &{\scriptsize ABF}&{\scriptsize ABD}& Run\\
- & - & - & - & - & - & -   & -   & (1) \\
+ & - & - & - & + & - & +   & +   & ae  \\
- & + & - & - & + & + & -   & +   & bef \\
+ & + & - & - & - & + & +   & -   & abf \\
...
Day1: (1), abce, bcdf, adef, abd, cde, acf, bef

Day2: ae, bc, df, abcdef, abf, cef, acd, bde
...
ACD=BDE=ABF=CEF 
 ...
 - - - - - - -  -  -  -  -  -  -   -   -
 A B C D E F AB AC AD AE AF BD BF ABD  Block
...
I=ABCE=BCDF=ADEF
 ...
 - the 16 runs to conduct  E=ABC; F=BCD; Block=ABD  
...
$\tau_i\sim N(0,\sigma^2_{\tau})$, $\beta_{j(i)}\sim N(0,\sigma^2_{\beta})$, $\sum_{k=1}^c\gamma_k=0$, $(\tau\gamma)_{ik}\sim N(0,\sigma^2_{\tau\gamma})$, $(\beta\gamma)_{kj(i)}\sim N(0,\sigma^2_{\beta\gamma})$, $\varepsilon_{(ijk)l}\sim N(0,\sigma^2)$
...
|term |i(r) |j(f) |k(f) |l(r) | df | EMS | F  |
| -- |   - |  -  |  -  |   - | --| ---| -- |
|$\tau_{i}$r             |1|b|c|n|a-1|$bcn\sigma^2_{\tau}+\sigma^2$|$\frac{A}{E}$|
|$\beta_{j(i)}$r         |1|0|c|n|a(b-1)|$cn\sigma^2_{\beta}+\sigma^2$|$\frac{B(A)}{E}$|
|$(\gamma)_{k}$f         |a|b|0|n|(c-1)|$\frac{abn}{c-1}\sum_{k=1}^{c}\gamma_k^2+bn\sigma^2_{\tau\gamma}+\sigma^2$|$\frac{C}{AC}$|
|$(\tau\gamma)_{ik}$r    |1|b|0|n|(a-1)(c-1)|$bn\sigma^2_{\tau\gamma}+\sigma^2$|$\frac{AC}{E}$|
|$(\gamma\beta)_{kj(i)}$r|1|0|0|n|a(b-1)(c-1)|$n\sigma^2_{\beta\gamma}+\sigma^2$|$\frac{BC(A)}{E}$|
|$\varepsilon_{(ijk)l}$|1|1|1|1|abc(n-1)|$\sigma^2$||
|Total| | | | |abcn-1|

If B(A) is random $F_C=8/(2.5+1.8-2.3)=4$, $df_2=\frac{(AC+BC(A)-E)^2}{\frac{AC^2}{df_{AC}}+\frac{BC(A)^2}{df_{BC(A)}}+\frac{E^2}{df_{E}}}=\frac{2^2}{\frac{2.5^2}{12}+\frac{1.8^2}{30}+\frac{2.3^2}{60}}=5.579\approx6$ P-value=0.07

<!-- (2^2)/(2.5^2/12+1.8^2/30+2.3^2/60) 
pf(3.2,3,12,lower.tail = F)
pf(4,3,6,lower.tail = F)
-->
...
|$\tau_{i}$r             |1|b|c|n|a-1|$bcn\sigma^2_{\tau}+\sigma^2$|$\frac{A}{E}$|
|$\beta_{j(i)}$r         |1|0|c|n|a(b-1)|$cn\sigma^2_{\beta}+\sigma^2$|$\frac{B(A)}{E}$|
|$(\gamma)_{k}$f         |a|b|0|n|(c-1)|$\frac{abn}{c-1}\sum_{k=1}^{c}\gamma_k^2+bn\sigma^2_{\tau\gamma}+n\sigma^2_{\beta\gamma}+\sigma^2$|$\frac{C}{AC+BC(A)-E}$|
|$(\tau\gamma)_{ik}$r    |1|b|0|n|(a-1)(c-1)|$bn\sigma^2_{\tau\gamma}+\sigma^2$|$\frac{AC}{E}$|
|$(\gamma\beta)_{kj(i)}$r|1|0|0|n|a(b-1)(c-1)|$n\sigma^2_{\beta\gamma}+\sigma^2$|$\frac{BC(A)}{E}$|
|$\varepsilon_{(ijk)l}$|1|1|1|1|abc(n-1)|$\sigma^2$||

If B(A) is fixed $F_C=8/2.5=3.2$ P-value=0.06

|term |i(r) |j(f) |k(f) |l(r) | df | EMS | F  |
| -- |   - |  -  |  -  |   - | --| ----| -- |
|$\tau_{i}$r             |1|b|c|n|a-1|$bcn\sigma^2_{\tau}+\sigma^2$|$\frac{A}{E}$|
|$\beta_{j(i)}$f         |1|0|c|n|a(b-1)|$\frac{cn}{a(b-1)}\sum{\beta^2}+\sigma^2$|$\frac{B(A)}{E}$|
|$(\gamma)_{k}$f         |a|b|0|n|(c-1)|$\frac{abn}{c-1}\sum_{k=1}^{c}\gamma_k^2+bn\sigma^2_{\tau\gamma}+\sigma^2$|$\frac{C}{AC}$|
|$(\tau\gamma)_{ik}$r    |1|b|0|n|(a-1)(c-1)|$bn\sigma^2_{\tau\gamma}+\sigma^2$|$\frac{AC}{E}$|
|$(\gamma\beta)_{kj(i)}$f|1|0|0|n|a(b-1)(c-1)|$\frac{n}{a(b-1)(c-1)}\sum{(\beta\gamma)^2}+\sigma^2$|$\frac{BC(A)}{E}$|
|$\varepsilon_{(ijk)l}$|1|1|1|1|abc(n-1)|$\sigma^2$||
