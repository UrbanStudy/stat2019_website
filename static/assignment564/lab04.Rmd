...
Among the estimators, $\hatβ_1$ has the the lagest variance $C_{22}=4.624$. $x_1$ has the least consistent. While $C_{11}=11.423$ is the lagest variance of parameter.  
