...
* Thirdly, the MSE value of model with intercept (75.36) is about half of the SSE with zero intercept (159), which shows the former is better fitted.

* Fourthly, the R-suqare value of model with intercept is 0.5983, means only 59.83% observations can be explained by this model. Meanwhile, the R-suqare value of model with zero intercept is 0.9929, which can explain more observation. We can find the reason that the sum square of total variation with intercept ($2693.6+1808.6=4502.2$) is about 1 percent of the SST with zero intercept ($551834+3968=555802$), which SSR contributs most of the R-suqare value.
