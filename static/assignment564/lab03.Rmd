...
Overall, the model with intercept is recommended because adding non-zero intercept improves the model with smaller MSE. To increase R-square or fit the pattern better, we should look for other advanced models. 
