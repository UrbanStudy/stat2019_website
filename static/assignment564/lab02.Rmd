...
> It is reasonable that the least-squares regression line passes through the point ($\beta_0,0$) when the intercept$\beta_0$ is known. 
...
$$$$
 ...
 > confidence intervals for $\beat_1$ will be narrower when $\beat_0$ is known,
