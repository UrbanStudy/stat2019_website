...
dtmp = as.matrix(read.table(url("http://www2.stat.duke.edu/~pdh10/FCBS/Inline/vostok.1999.temp.dat"), header = TRUE))
dco2 = as.matrix(read.table(url('http://www2.stat.duke.edu/~pdh10/FCBS/Inline/vostok.icecore.co2.dat'), header = TRUE))
