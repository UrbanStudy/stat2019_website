...
Therefore, this function is an exponential family. The natural parameter is $(\eta_1,\eta_2)=(-\frac1{2a\theta^2},\frac1{a\theta})$ with natural parameter space{$():\eta_1<0,-\infty<\eta_2<\infty$}. The $\theta$ parameter vector lies on a parabola.
...
Therefore, this function is an exponential family. The natural parameter is $(\eta_1,\eta_2)=(\alpha-1,-\alpha)$ with natural parameter space{$(\eta_1,\eta_2):\eta_1>-1,\eta_2<0$}. The $\alpha$ parameter vector lies on a line.
...
Therefore, this function is an exponential family. The natural parameter is $(\eta_1,\eta_2,\eta_3)=(4\theta,-6\theta^2, 4\theta^3)$ with natural parameter space{$(\eta_1,\eta_2,\eta_3): -\infty<\eta_1>\infty,\eta_2<0,-\infty<\eta_3>\infty$}. The $\theta$ parameter vector lies on a 3D line.
...
Beacuse $x_{\alpha}=\sigma z_{\alpha}+\mu$, $z_{\alpha}=\frac{x_{\alpha}-\mu}{\sigma}$


$$f_X(\sigma z+\mu)|\frac{d(\sigma z+\mu)}{dz}|=\frac1{\sigma}f(\frac{\sigma z+\mu-\mu}{\sigma})\sigma=f_Z(z)$$

$$P(X>x_{\alpha})=P(\sigma Z+\mu>\sigma z_{\alpha}+\mu)= P(Z>z_{\alpha})=\alpha $$