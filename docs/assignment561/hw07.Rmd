...
$$P(X>x_{\alpha})=\int_{x_a}^{\infty}\frac1\sigma f(\frac{x-\mu}{\sigma})dx=\int_{\sigma z_a+\mu}^{\infty}\frac1{\sigma}f(\frac{\sigma z+\mu-\mu}{\sigma}) d(\sigma z+\mu)$$

$$=P(\sigma Z+\mu>\sigma z_{\alpha}+\mu)=\int_{z_{\alpha}}^{\infty}f(z)dz= P(Z>z_{\alpha})=\alpha $$