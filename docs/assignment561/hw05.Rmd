...
$$P(X=0|N=100,5<M<(100-k),k\ge1)=\sum_{M=6}^{100-k}\frac{\binom{M}{0}\binom{100-M}{k}}{\binom{100}{k}}=1-\sum_{M=0}^{5}\frac{\binom{M}{0}\binom{100-M}{k}}{\binom{100}{k}}<0.10$$
 By trail and error?
...
$$P(X=0 or 1|N=100,5<M<(100-k),k\ge1)=\sum_{M=6}^{100-k}\frac{\binom{M}{0}\binom{100-M}{k-0}+\binom{M}{1}\binom{100-M}{k-1}}{\binom{100}{k}}<0.10$$
...
$$\therefore P(X\le 1)=P(X=1)+P(X=2)=e^{-\lambda}\frac{\lambda^0}{0!}+ e^{-\lambda}\frac{\lambda^1}{1!}\le0.01$$
