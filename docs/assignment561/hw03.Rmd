...
$$\lim_{n\to\infty}F(x)=\lim_{n\to\infty}P((-\infty, x])=P(\lim_{n\to\infty}(-\infty, x])=P(-\infty, \infty)=1$$

$$\lim_{n\to-\infty}F(x)=\lim_{n\to-\infty}P((-\infty, x])=P(\lim_{n\to-\infty}(-\infty, x])=P(\emptyset)=0$$
...
$$\because Y=d\tan X,\quad \therefore X=\arctan\frac Yd$$

 > $Y=d\tan X$ is a monotone inecreasing function. We can use shortcut.

Let $F_X(x)=cx$ is a cdf, $\lim_{n\to\infty}cx=1,\quad0<x<\pi/2$. Hence, $c=\frac2\pi$ safisfy the equation.

$$\therefore F_X(x)=\frac{2x}\pi,\quad  f_X(x)=\frac2\pi\quad 0<x<\pi/2$$

$$f_Y(y)=f_X(x)|\frac{dx}{dy}|=\frac2\pi|\frac{d(\arctan\frac yd)}{dy}|=\frac2\pi\frac{d(\frac yd)}{[(\frac yd)^2+1]}=\frac{2}{\pi d[(\frac yd)^2+1]}$$
...
$$\lim_{x\to\infty}F_X(x)=\lim_{x\to\infty}x^3=1\quad 0<x<1$$

> F(x) is a cdf and has a pdf f(x).

$$(1)\quad \int_{0}^m{f(x)dx}=m^3-0=\frac12,\quad m=(\frac12)^{\frac13}$$

$$(2)\quad \int_m^{1}{f(x)dx}=1-m^3=\frac12$$
...
$$\lim_{x\to\infty}F_X(x)=\frac1\pi(\frac\pi2+\frac\pi2)=1$$

> F(x) is a cdf and has a pdf f(x).

$$(1)\quad \int_{-\infty}^m{f(x)dx}=\frac{\arctan m-\pi/2}{\pi}=\frac12,\quad \arctan m=0,\quad m=0$$

$$(2)\quad\int_m^{\infty}{f(x)dx}=\frac{\pi/2-\arctan m}{\pi}=\frac12$$
