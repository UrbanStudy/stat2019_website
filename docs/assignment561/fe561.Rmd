...
$$\Gamma(\frac{2k+1}2)=(k-\frac12)\Gamma(k-\frac12)=(k-\frac12)(k-\frac32)\Gamma(k-\frac32)=...=\prod_{i=1}^k(k-i+\frac{1}2)\Gamma(\frac12)=\prod_{i=1}^{k}(i-\frac{1}2)\sqrt{\pi}$$
...
Therefore, $\mu\in(2,3)$ for x=1 is the unique mode.
