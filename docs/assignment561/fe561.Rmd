...
$$(a-1-\frac{x}\beta)=0\implies x=(\alpha-1)\beta,\quad \alpha\ge1$$
...
$$=\frac{0.005\times 0.99}{0.005\times0.99+0.995\times0.02}=0.1991952$$
...
Since $x=1$ is the unique mode, so $x=[\mu]$ where $[\mu]$ denotes the greatest integer that does not exceed $\mu$. 
