...
```
 ...
 ----------------- -------- ----- --------- -----------
  **(Intercept)**   100173    1     702.1    5.308e-80 

   **g**            417.6     1     2.927     0.08816  

   **r**            2309      1     16.18    7.318e-05 
...
According to ANOVA table, there is not a significant interaction effect from ranks and genders on the score at 5% significance level (P-value=0.6253). That means, effect of ranks and effect of genders on y is independent. Therefore, examine the main effects.

According to type III ANOVA table, there is a significant effect from genders on the score at 5% significance level (P-value=$7.318\times e^{-5}$).
