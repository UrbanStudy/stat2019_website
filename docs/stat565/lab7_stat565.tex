...
\CommentTok{# Because the multi-way ANOVA model is over-parameterised, #}
\CommentTok{# it is necessary to choose a contrasts setting that sums to zero.#}
\CommentTok{# otherwise the ANOVA analysis will give incorrect results with respect #}
\CommentTok{# to the expected hypothesis. (The default contrasts type does not satisfy this requirement.)}
