...
t.test(table_cellphone$TenSeconds, table_cellphone$TwentySeconds, paired = T,var.equal=T, alternative="less", mu = 0, conf.level= 0.95)
...
A 95% confidence bound of (-Inf -2.176087) suggests that we can be 95% sure the mean of differences in scores of housings between 10 seconds and 20 seconds of cool-down times is at least -2.176087. In other words, on average, the scores of housings is better for 20-seconds cool-down times than 10-seconds.
