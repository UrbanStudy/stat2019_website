...
P-value is less than significance level (5%) and null hypothesis ($H_0$) is rejected. A 95% negative confidence bound of (-4.32887 -1.97113) excluding 0 suggests that the difference in average scores of housing with 10 seconds and 20 seconds of cool-down times is between -4.32887 and -1.97113. In other words, we can conclude that the scores of housings with 10-second and 20-second cool-down times are significantly different at 5% significance level.
