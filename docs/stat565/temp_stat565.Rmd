...
E[\beta_j]-\frac1{a}\sum_{i=1}^aE[\beta_j]+\frac1a \sum_{i=1}^aE[ε_{ij}]-\frac1{ab}\sum_{i=1}^a\sum_{j=1}^bE[ε_{ij}]=0&\text{RB-RCBD}
\end{cases}$$
...
| ---   |   ---               |---|---|
|FT-CRD |$\frac{(n+1)\sigma_{\tau}^2}{n}-\frac{\sigma^2}{an}$| $+\tau_i^2=$ |$\frac{(a-1)\sigma^2}{an}+\tau_i^2$|
|RT-CRD |$\frac{(n\sigma_{\tau}^2+\sigma^2)(n-1)}{an}$| $+0=$ |$\frac{(n-1)(n\sigma_{\tau}^2+\sigma^2)}{an}$|
...
| ---   |   ---               |---|---|
|FB-RCBD|$\frac{(a-1)\sigma^2}a$|$+\tau_i=$|$\frac{(a-1)\sigma^2}a+\tau_i^2$|
|RB-RCBD|$\frac{(a-1)\sigma^2}a$|$+\tau_i=$|$\frac{(a-1)\sigma^2}a+\tau_i^2$|
