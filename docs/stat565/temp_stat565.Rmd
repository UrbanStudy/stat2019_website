...
|Total | 550 |29|
 ...
 (5) If treatment effect was fixed and block effect was random,
  (a) compute the estimated variance for blocks.$\hat\sigma_{Blk}^2=\frac{MS_{Blk}-MS_{Blk}}{a}=\frac{40-10}6=5$
...
|$\hat\tau_i$|$\hat\beta_j$|$\hat\sigma^2$|$\hat\sigma_{Trt}^2$|$\hat\sigma_{Blk}^2$|$\widehat{Var(\bar y_{i.})}$|
| --- |    ---     |  ---        |  ---        |   ---       | ---      |
|$\bar y_{i.}-\bar y_{..}$|$\bar y_{.j}-\bar y_{..}$|MSE|$\frac{MS_{Trt}-MS_{E}}{n}$|$\frac{MS_{Blk}-MS_{Blk}}{a}$|$\frac{MS_{Trt}}{n}$
