...
power.anova.test(groups = 3, n =5,between.var = 598.07, within.var = 15.6, sig.level = 0.05, power = NULL)

power.anova.test(groups = 2, n =5,between.var = 100.4, within.var = 15.6, sig.level = 0.05, power = NULL)
