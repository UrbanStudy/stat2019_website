...
$$=bn\sum_{i=1}^aτ_i^2+bn\sum_{i=1}^a\frac1{(bn)^2}\sum_{j=1}^b\sum_{k=1}^nE[ε_{ijk}^2]+bn\sum_{i=1}^a\frac1{(abn)^2}\sum_{i=1}^a\sum_{j=1}^b\sum_{k=1}^nE[ε_{ijk}^2]+0-0-2bn\sum_{i=1}^aCov\left[\frac1{bn}\sum_{j=1}^b\sum_{k=1}^nε_{ijk},\frac1{abn}\sum_{i=1}^a\sum_{j=1}^b\sum_{k=1}^nε_{ijk}\right]$$ 
