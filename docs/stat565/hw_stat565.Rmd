...
There is not obvious violation of normality in histogram plot.

The QQ plot does not show obvious violation of normality.
...
```{r echo=T,collapse=F, out.width='24%'}
...
The violation of normality in QQ plot and histogram are not obvious as before.
...
The results of estimating regression coefficients show the P-value of Design1 and RegionNE(0.000006), Design2(0.000105), RegionNW(0.004490), RegionSW(0.002479) are smaller, while the P-value of Design3(0.376944) and RegionSE(0.076721) are still larger than 0.05.  The coefficients of Design1, RegionNE, Design2, RegionNW, RegionSW are significant at 0.05 significant level. The rest are not.
