...
```{r echo=T, collapse=F}
model_wash <- lm(Response~Solution+Days, data=table_wash)
summary(aov(Response~Solution+Days, data=table_wash))
summary(model_wash)
# (LSD.test(model_wash, trt="Solution",alpha = 0.05))
...
pairw.anova(table_wash$Response,table_wash$Solution, conf.level = 0.95, method = "lsd", MSE = NULL, df.err = 6, control = NULL)
pairw.anova(table_wash$Response,table_wash$Solution, conf.level = 0.95, method = "tukey", MSE = NULL, df.err = 6, control = NULL)

# (LSD.test(aov(Response~Days+Solution, data=table_wash), trt="Days",alpha = 0.05))
...
pairw.anova(table_wash$Response,table_wash$Days, conf.level = 0.95, method = "lsd", MSE = NULL, df.err = 6, control = NULL)
pairw.anova(table_wash$Response,table_wash$Days, conf.level = 0.95, method = "tukey", MSE = NULL, df.err = 6, control = NULL)
...
```{r echo=T, collapse=F}
model_mail <- lm(Response~Design+Region, data=table_mail)
summary(model_mail)
```
...
(LSD.test(model_mail, trt="Region",alpha = 0.05))
pairw.anova(table_mail$Response,table_mail$Region, conf.level = 0.95, method = "lsd", MSE = NULL, df.err = NULL, control = NULL)
``` 
...
plot(aov(Response~Design+Region, data=table_mail))
plot(aov(Response~Region+Design, data=table_mail))
```
...
For $y_{i...}=np\bar y_{i...}$, $y_{.j.l}=p^2\bar y_{.j.l}$, $y_{..k.}=np\bar y_{..k.}$, $y_{...l}=p^2\bar y_{...l}$,
