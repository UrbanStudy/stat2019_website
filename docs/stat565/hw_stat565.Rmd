...
The ANOVA for Latin-square shows that ingredients have significant effects on the average values of reaction time at 0.05 significant level. The P-value of 0.000488 for treatment is small enough.

 (d) Test the significance of different batches of material at α=0.05. Report your conclusion and p value here.

The reaults of TukeyLSD test show that there is not significant difference on the average values of reaction time among the batches at 0.05 significant level. The P-value of all the paired comparing among batches is large enough. All of the confident intervals include zero.
...
The P-value of 0.000107 for treatment is samller than 0.01. The ANOVA for replicated Latin-square shows that the treatments have significant effects on the average values of resopnse variable at 0.01 significant level. 
