...
$$=bn\sum_{i=1}^aτ_i^2+bn\sum_{i=1}^aE[\bar ε_{i..}^2]+bn\sum_{i=1}^aE[\bar ε_{...}^2]+0-0-2bnCov(a\bar ε_{...},a\bar ε_{...})$$ 

$$=bn\sum_{i=1}^aτ_i^2+\frac{a}{bn}σ^2+\frac{1}{abn}σ^2-2abnσ^2=bn\sum_{i=1}^aτ_i^2+\frac{a^2+1-2a^2b^2n^2}{abn}σ^2$$ 

 ---

$$=bn\sum_{i=1}^aτ_i^2+{a}σ^2-σ^2=bn\sum_{i=1}^aτ_i^2+(a-1)σ^2$$ 