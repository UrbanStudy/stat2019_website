...
$$\frac{SSE}{\chi^2_{\alpha/2,df_E=15}}=0.066/24.99579=0.002640445\qquad \frac{SSE}{\chi^2_{1-\alpha/2,df_E=15}}=0.066/7.260944=0.009089727$$

The 95% confidence interval for the true error variance is $[0.002640445,0.009089727]$
...
qchisq(0.05, 15, lower.tail = F, log.p = FALSE)

qchisq(0.95, 15, lower.tail = F, log.p = FALSE)
