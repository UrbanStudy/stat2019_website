...
pf(132.6125/29.8, 1, 16, lower.tail = TRUE, log.p = FALSE)
qf(132.6125/29.8, 1, 16, lower.tail = TRUE, log.p = FALSE)
```
...
|         ---       |   ---         |   ---        | ---    | ---    | ---      |
|Factor A           |132.6125       |   $2-1=1$    |132.6125|4.450084|0.02312363|
|Factor B           | 63.0125       |   $2-1=1$    | 63.0125|2.114513|0.1822612 |
|Interaction AB     | 37.8125       |$(2-1)(2-1)=1$| 37.8125|1.268876|0.1822612 |
|Error              |$29.8*16=476.8$|$4*(5-1)=16$  | 29.8   |
|Total              |710.2375       |$2^2*5-1=19$  |

(v) Based on your ANOVA table, explain which of effects in part (i) are statistically significant at 5% significance level.

### Problem 2: 

(i) Create a table of plus and minus for a 25 factorial design. Make sure to use standard order of letter assignments for treatment combinations.
