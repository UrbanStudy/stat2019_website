...
$$\therefore Cov(\hat\beta_0, \hatβ_1)=\left[\frac0{nS_{xx}}-\frac{\bar x}{S_{xx}^2}\right]\sigma^2=−\bar x\frac{\sigma^2}{S_{xx}}$$
...
take the derivative of this with respect to /31 and set it equal to zero.

$$-2\sum_{i=1}^n(y_i-\beta_0-\hat\beta_1x_i)x_i=0$$
