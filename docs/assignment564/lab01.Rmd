...
$Z_i=\frac{X_i-\mu}n$ is called a **standard normal random variable**.  
 ...
 > According to the definition of Chi-square distribution,  when $X_i$ be indepentdent normally distributed random variables with $ E(X_i)=\mu\quad and\quad  Var(X_i)=\sigma^2\quad \frac{X_{i}-\mu}{\sigma}=Z_i$  
