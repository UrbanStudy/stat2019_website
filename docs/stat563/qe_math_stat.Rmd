...
### 2011S5
[2013FB3][] [2015S2B][] [2018S2B][] [@Expo] [@FishI] [@CRLB]

Let $X_1,X_2,..,X_20$ be a random sample from exponential distribution with p.d.f.
...
Let $X$ be a $uniform[O,1]$ random variable. Let $Y$, given $X$, be $uniform[0,X]$.
...
### 2013FB3
[2011S5][] [2015S2B][] [2018S2B][] [@Expo] [@FishI] [@CRLB]
...
### 2014F4A
[2007F2A][] [2015S2A][] [2019SA2][]

The lifetime (in hours) Y of an electronic component is a random variable
...
### 2015S2B
[2011S5][] [2013FB3][] [2018S2B][] [@Expo] [@FishI] [@CRLB]
...
### 2018S2B
[2011S5][] [2013FB3][] [2015S2B][] [@Expo] [@FishI] [@CRLB]
