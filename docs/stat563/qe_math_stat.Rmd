...
<div style="float: left; width: 33%;"> **1** one **2** two 
</div> 
<div style="float: left; width: 33%;"> **3** three **4** four **5** five **6** six 
</div> 
<div style="float: right; width: 33%;"> **7** seven **8** eight **9** nine 
</div>
...
Let X and Y be independent random variables. Let $g(x)$ be a function only of a; and $h(y)$ be a function only of y. Then the random variables $U=g(X)$ and $V=h(Y)$ are independent.
...
$E_\theta\left[(\frac{\partial}{\partial\theta}\lnf(X|\theta))^2\right]=-E_\theta\left[\frac{\partial^2}{\partial\theta^2}\ln f(X|\theta)\right]$
