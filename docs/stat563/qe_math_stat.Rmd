...
Let $X$ be a continuous random variable with PDF $f(x)=1−|x|$, with $−1<x<1$. Let $Y=X2$. Find the PDF of $Y$.
...
(a) $E[(X-\mu/\sigma)^2]\ge1$.

(b) $E[(X-\mu/\sigma)^4]\ge1$.
...
For testing $H_0:\theta=0$ against the alternative $H_a:\theta>1$, a reasonable test is to reject $H_0$ if $X_{(n)}=\man\{X_1,X_2,..,X_{10}\}\ge C$. Find $C$ so that type I error probability is .05. Also find the power of the above test at $\theta=1.5$.
...
### 2016S5
[2003S3][] [2004F11][] [2007F3A][] [2008S2A][] [2010SA4][] [2015S1Ab][] [2016F8][] [2018FA1][] [2019SA1 ][] [@joint] [@marg]
...
### 2016F7
[2003S7][] [2008F5][] [2009SB1][] [2009FB4][] [2016S4][] [2017FB4][] [2018FB2][] [2019SB4][] [@UMP]
...
### 2018S3B
[2003S9][] [2004F9][] [2007F5B][] [2015S4B][] [2019SB3][] [@SPower] [@power] [@UMP]
...
### 2018S4B
[2004F12][] [2010SB4][] [2010FB4][] [2011S6][] [2015F5][] [@Expo] [@LRT] [@HypoT] [@power]
