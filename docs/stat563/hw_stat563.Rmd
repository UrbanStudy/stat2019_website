...
$\lambda=\sigma^2_{\delta}/\sigma^2_{\varepsilon}=\frac{S_{xx}/n}{S_{yy}/n}=1$, $S_{xx}=S_{yy}$

For $\lambda=1$, when $S_{xy}>0$,
...
For $S_{yy}\ge0$, $S_{xx}\ge0$, when $S_{xy}<0$, $\frac{-S_{xy}}{S_{xx}}<-\hat\beta(\lambda)<\frac{S_{yy}}{-S_{xy}}$, therefor,
