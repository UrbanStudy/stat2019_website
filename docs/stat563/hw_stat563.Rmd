...
The unrestricted MLEs of 2Xand 2Yare ˆ2X= X2in and ˆ2Y= Y 2im , as usual. Under therestriction,  = 0, 2Y= 02X, and
...
where F = Y 2i /0mX2i /n Fm,n under H0. The rejection region is
...
To ease notation, let a = m/(n +m) and b = aPy2i Px2i. From the duality of hypothesis tests and confidence sets, the set
...
These densities have already appeared in Exercise 8.8, where LRT statistics were calculated for testing H0 : a = 1.


Using the result of Exercise 8.8(a), the restricted MLE of  (when a = a0) is
...
Using the results of Exercise 8.8b, the restricted MLE (for a = a0) is found by solving
...
b = a + 1 −  will do. One choice is a = −1
2 + 
2 , b = 1
2 − 
2 .
...
Any a and b satisfying b2 = a2 + 1 −  will do. One choice is a =
p/2, b =
p
1 − /2.
