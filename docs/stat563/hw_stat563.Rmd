...
$$f_{Y_{1},Y_{n}}(y_1,y_n|\theta)=\frac{n!}{(1-1)!(n-1-1)!(n-n)!}f_{Y_{1}}(y_1|\theta)f_{Y_{n}}(y_n|\theta)[F_{Y_{1}}(y_1|\theta)]^{1-1}[F_{Y_{n}}(y_n|\theta)-F_{Y_{1}}(y_1|\theta)]^{n-1-1}[1-F_{Y_{n}}(y_n|\theta)]^{n-n}$$
$$=n(n-1)(y_1-y_n)^{n-2},\ \theta<y_1<y_n<\theta+1$$
...
For $\theta\ge k=1-\alpha^{1/n}$, $\beta(\theta)=1$. So these conditions are satisfied for any n.
