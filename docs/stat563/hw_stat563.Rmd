...
$$=\frac{2}{(1+b^2)^3}[(S_{xx}-S_{yy})(1-3b^2)+2bS_{xy}(3-b^2)]=c$$
...
When $b(S_{xx}-S_{yy})=S_{xy}(1-b^2)$

$$\frac{(1+b^2)^3}{2}c=\frac{S_{xy}}b(1-b^2)(1-3b^2)+2bS_{xy}(3-b^2)=\frac{S_{xy}}b(1+2b^2+b^4)=\frac{S_{xy}}b(1+b^2)^2$$

$$\frac{(1+b^2)}{2}c=\frac{2S_{xy}^2}{-(S_{xx}-S_{yy}) +\sqrt{(S_{xx}-S_{yy})^2 +4S_{xy}^2}}>0$$

For $\frac{\partial^2 f(b)}{\partial b^2}=c>0$, $f(b)$ has gives the minimum of $f(b)$.
...
(c) Show that $\hat\beta(\lambda)$ is, in fact, monotone in $\lambda$ and is increasing if $S_{xy}>0$ and decreasing if $S_{xy}<O$.

$$\frac{d}{d\lambda}\hat\beta(\lambda)=\frac{-(S_{xx}-\lambda S_{yy}) + \sqrt{(S_{xx}-\lambda S_{yy})^2 +4\lambda S_{xy}^2}}{2\lambda S_{xy}}$$
...
$\lambda=1$, $S_{xx}=S_{yy}$

$$\begin{cases}\frac{S_{yy}}{S_{xy}}<1<\frac{S_{xy}}{S_{xx}}& if\  S_{xy}>S_{xx}=S_{yy} \\\frac{S_{xy}}{S_{xx}}<1<\frac{S_{yy}}{S_{xy}}& if\  S_{xy}<S_{xx}=S_{yy} \end{cases}$$
...
$\lambda=S_{xx}/S_{yy}=0.006696296$
