...
$$=\frac{2(S_{xx}-S_{yy})}{(1+b^2)^2}-\frac{8b^2(S_{xx}-S_{yy})}{(1+b^2)^3}-\frac{4bS_{xy}}{(1+b^2)^2}+\frac{8bS_{xy}}{(1+b^2)^3}=\frac{2(S_{xx}-S_{yy}-2bS_{xy})}{(1+b^2)^2}-\frac{8b(bS_{xx}-bS_{yy}-S_{xy})}{(1+b^2)^3}$$

$$=\frac{2(S_{xx}-S_{yy})(1-3b^2)}{(1+b^2)^3}-\frac{4bS_{xy}(1+b^2)}{(1+b^2)^3}+\frac{8bS_{xy}}{(1+b^2)^3}=\frac{2}{(1+b^2)^3}[(S_{xx}-S_{yy})(1-3b^2)+4bS_{xy}(1-b^2)]=c$$
