...
\subsubsection{Normal-inferior goods}
...
\subsubsection{Substitution-Complementary good}
...
Whether it is one or the other depends on the specific context of the market, and it can be a substitute good within the center of a dense urban area where consumers are taking short trips or it can be a complementary good in areas further away from the denser parts of a city.
...
the fare elasticity of demand for transit service varied across income groups. The elasticity of demand was greatest for the low income group, and lowest for the high income group. $\eta=\frac{\Delta Q/Q}{\Delta P/P}$

Income elasticity of demand $\eta=\frac{{\Delta Q}/Q}{{\Delta In}/In}=\beta_i\frac{\bar{In}}{\bar{Q}}$
...
\subsubsection{Aggregate-Disaggregate demand model}

$\widehat{\Delta G}=\beta1*\Delta Pr+\beta2*\Delta In$ | $U_j = V(X_j, S;\beta) + \varepsilon_j$ $P_i=\frac{e^{V_i}}{\sum_{j=1}^Je^{V_j}}$
...
maximize profit by setting the marginal cost equal to marginal revenue MC=MR. This corresponds to an efficiency (deadweight) loss. Profit=TR-TC Monopolist profit-maximization; TR=PQ, $\%\Delta_{Rev}=\frac{P_2Q_2-P_1Q_1}{P_1Q_1}$
