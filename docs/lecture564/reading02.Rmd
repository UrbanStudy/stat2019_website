...
$$t=\frac{\hat{\beta_1}-\beta_{10}}{se(\beta_1)}=\frac{\hat{\beta_1}-\beta_{10}}\sqrt {MSE/S_{xx}}=\dfrac{\hat{\beta_1}-\beta_{10}}{\sqrt{MSE/\sum(x_i-\bar{x})^2}}$$
...
because $E(MSR)=\sigma^2+\beta_1^2S_{xy}$
