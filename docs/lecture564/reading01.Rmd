...
$$y_i=\beta_0+\beta_1x_i1+\beta_2x_i2+..+\beta_kx_ik+\varepsilon_i=\beta_0+\sum_{\beta_j}x_ij+\varepsilon_i$$
...
$$SSE=S(\hat\beta_0,\hat\beta_1)=\sum_{i=1}^n\hat\varepsilon_i=\sum_{i=1}^n(y_i-\hat y)=\sum_{i=1}^n(y_i-\hat\beta_0-\hat\beta_1x_i)^2$$

$$=(Y-X\beta)'(Y-X\beta)=YY'-2Y'X\beta+\beta'X'X\beta$$$
...
$$\sum_{i=1}^nx_iy_i=\hat\beta_0\sum_{i=1}^nx_i+\hat\beta_1\sum_{i=1}^nx_i^2;\quad \mathbf{X'Y=X'X\beta}$$
...
$$E(S_{\varepsilon\varepsilon})=E(S_{\varepsilon}^2)=\sigma^2$$
