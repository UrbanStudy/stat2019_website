...
### Special Cases
   ...
   |intercept known|slope known | through origin
---|---|---|---
model $y_i$      |$\beta_0+\hat\beta_1x_i+\varepsilon$|$\beta_1x_i+\varepsilon_i$|$\hat\beta_0+\beta_1x_i+\varepsilon$
$\hat\beta_{1,0}$|$\frac{\sum_{i=1}^n(y_i-\beta_0)x_i}{\sum_{i=1}^nx_i^2}$|$\frac{\sum_{i=1}^ny_ix_i}{\sum_{i=1}^nx_i^2}$|$\bar y-\beta_1\bar x$
...
$y_i=\beta_0+\hat\beta_1x_i+\varepsilon$;
...
$y_i=\hat\beta_0+\beta_1x_i+\varepsilon$
...
$$y_i=\beta_1x_i+\varepsilon_i\quad where\ \epsilon_i\sim iid N(0,\sigma^2)$$
