...
|---|---|---|---|---|---
se |$\sqrt{MSE(\frac1n+\frac{\bar x^2}{S_{xx}})}$|$\sqrt{\frac{MSE}{S{xx}}}$| $\sqrt{C_{jj}MSE}$ | $\sqrt{MSE\left[\frac1k+\frac1n+\frac{(x_0-\bar x)^2}{S_{xx}}\right]}$ | $\sqrt{\hat\sigma^2(1+\mathbf{x_0'(X'X)^{-1}x_0})}$
