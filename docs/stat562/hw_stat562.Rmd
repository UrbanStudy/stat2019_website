...
$$(1+\frac{(z-w)^2}{\tau^2})(Aw+B)-(1+\frac{w^2}{\tau^2})(Cw+D)=1$$
...
\frac{B-2Az}{\tau^2}-\frac{D}{\sigma^2}=0 &(2)\\
\frac{A\tau^2+Az^2-2Bz}{\tau^2}-C=0 &(3)\\
\frac{B\tau^2+Bz^2}{\tau^2}-D-1=0 &(4)
\end{cases}$$
...
Let $g(u)=\sqrt U$, then $E[g(u)]=\int_0^{\infty}g(u)f(u)du$
