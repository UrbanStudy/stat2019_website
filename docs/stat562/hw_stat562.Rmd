...
**6.30** Let $X_1,..,X_n$ be a random sample from the pdf f(x ifJ.) = e-(x-!-') , where -00 < fJ. <x < 00.

(a). Show that $X(1) = min$; $X_i$ is a complete sufficient statistic.

(b). Use Basu's Theorem to show that $\bar X$ and $\sigma^2$ are independent.
...
**7.11** Let $X_1,..,X_n$, be iid with pdf
