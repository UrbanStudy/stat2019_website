...
plot(function(x){-2*x}, from=-5, to=2, axes=FALSE, asp=1)
...
plot(function(x){x}, from=-0.5, to=1.5, axes=FALSE, asp=1)
axis(1, pos=0, xlab="x");abline(v =0.6, lty = 2)
axis(2, pos=0, ylab="y");abline(h =0.8, lty = 2)
