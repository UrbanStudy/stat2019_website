...
Step 2 $E[\hat\lambda_{MLE}]$

$E[\hat\lambda_{MLE}]=\frac{n\lambda}{n-1}$


Step 3 $\hat\lambda_{u}$

$\hat\lambda_{u}=\frac{n-1}{\sum x_i}$


Step 4 CRLB for unbiased

$\frac{1}{nI(\lambda)}=\frac{1}{n\frac1{\lambda^2}}=\frac{\lambda^2}{n}$


'Step 5 $V[\hat\lambda_{MLE}]$'

$V[\hat\lambda_{MLE}]=\frac{n^2\lambda^2}{(n-1)^2(n-2)}$



Step 6 $V[\hat\lambda_{u}]$

$V[\hat\lambda_{u}]=V[\frac{n-1}n\hat\lambda_{MLE}]=\frac{\lambda^2}{n-2}$

efficiency of $\hat\lambda_{u}$ is $\frac{\lambda^2/n}{\lambda^2/(n-2)}=\frac{n-2}n$

$\therefore \hat\lambda_{u}$ is not efficient is asymptotic efficient. $\hat\lambda_{MLE}$ is also asymptotic efficieint.
